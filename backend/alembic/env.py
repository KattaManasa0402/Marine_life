...
# Set the SQLAlchemy URL from our application settings, which reads from the environment variables
# We replace 'asyncpg' with 'psycopg2' because Alembic runs synchronously.
